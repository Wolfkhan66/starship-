 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_DEBRIS , SFASSET_CLOUD2 ,SFASSET_CLOUD4 , SFASSET_HEALTHPACK, SFASSET_HEALTHBAR};
